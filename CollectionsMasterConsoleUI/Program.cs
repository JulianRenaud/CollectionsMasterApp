...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes we have the item you're looking for!");
            }
            else
            {
                Console.WriteLine($"Bad news, we dont have that item in stock!");
                Console.WriteLine($"Come around next week!");
            }
        }
